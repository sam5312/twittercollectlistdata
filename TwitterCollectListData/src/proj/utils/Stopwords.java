...
public class Stopwords {
  ...
  public static Stopwords m_Stopwords;
...
/** 
  ...
  public static boolean isStopword(String str) {
	 ...
	 * @param stopfile
	 */
	public static void addStopfile(String stopfile) {
		ArrayList<String> tokens = new ArrayList<String>();
		FileUtil.readLines(stopfile, tokens);
